...
namespace Game.Core
{
    ...
    /// 반대편에서 들어오는" 효과를 낸다(Docs/설계/04-2026-08-25-Field씬_아키텍처.md §7 의도 재현). 양방향 모두
    /// 슬라이드 애니메이션을 사용한다(전투 뷰 복귀 시 즉시 전환한다는 §7 원안은 실플레이 피드백에
    /// 따라 폐기 - Docs/제작/02-2026-08-25-인카운터_전투전환_구현.md 참고). MonoBehaviour가 아닌 순수 C# 합성
    ...
    internal class FieldCameraController
    {
        ...
        // (Docs/설계/10-2026-08-26-씬전환_연출_아키텍처.md §3).
